...
public class KickHitAction extends AbstractInputAction {
	private Model3DTriMesh s;
	private Matrix3D sM;
	private MyClient client;
	private TerrainBlock terrain;
   private Sound kickHitSound;
   private FightingGame myGame;

	public KickHitAction(Model3DTriMesh n, MyClient thisClient, FightingGame game, Sound theKickHitSound) {
		s = n;
		client = thisClient;
      myGame = game;
      kickHitSound = theKickHitSound;
	}
